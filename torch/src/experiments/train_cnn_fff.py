...
class TrainCNNFFF:
    ...
    def setup(self, partial_model, optim, sched, sig_sched, loader, device):
        ...
        self.sig_sched = sig_sched(self.model.classifier.alpha)
    ...
    def log_epoch(self, train, train_inf, val, epoch, best_val, testloader, device):
        ...
        sigmoid_alpha, (lr,) = self.model.classifier.alpha.item(), self.sched.get_lr()
        ...
        if better_acc or better_loss:
            ...
            test_loss, test_acc, _, _, _, _, _ = eval_model_cnn(self.model, testloader, device)

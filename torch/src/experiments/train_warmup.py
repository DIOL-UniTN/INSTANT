...
from utils.nn import train_epoch_infa, train_epoch_warmup, eval_model
from utils.fff import LeafStats

class TrainingWarmup:
    def __init__(self, mlflow_id):
        self.mlflow_id = mlflow_id # 1 - training
        self.exp_name = "TrainingWarmup"
    ...
    def setup(self, partial_model, optim, sched, sig_sched, loader, device):
        ...
        self.sig_sched = sig_sched(self.model.sig_alpha)
    ...
    def log_epoch(self, train, train_inf, val, epoch, best_val, testloader, device):
        ...
        logging.info("LR: {:.6f}, Sigmoid alpha {:.1f}".format(
                     lr, sigmoid_alpha))
    ...
    def run(self, cfg):
        ...
        self.start_run(cfg.proj_name, cfg.username, cfg.mlflow_pass, cfg.run_name, 
                       cfg.debug_level)

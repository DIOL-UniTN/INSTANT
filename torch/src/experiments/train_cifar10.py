...
class TrainCifar10:
    def __init__(self, mlflow_id):
        ...
        self.exp_name = "TrainSimpleDLA"

    def setup(self, optim, sched, loader, device):
        ...
        self.model = SimpleDLA(num_classes=loader.out_dim).to(device)
    ...
    def run(self, cfg):
        ...
        self.setup(cfg.optim, cfg.sched, cfg.loader, cfg.device)

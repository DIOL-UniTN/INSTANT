...
class TrainingFF:
    def __init__(self, width, mlflow_id):
        self.mlflow_id = mlflow_id
        self.exp_name = "TrainingFF"
        self.width = width

    def setup(self, model, optim, loader, device):
        ...
        self.model = FF(in_features=loader.in_chan*loader.in_size[0]*loader.in_size[1], 
                        width=self.width, out_features=loader.out_dim).to(device)

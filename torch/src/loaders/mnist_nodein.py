...
class MNISTLoader:
    def __init__(self, batch_size: int, transform, aug, aug_prob:float, ltarget_transform, debug_level: bool):
        ...
        trainset = MNISTSubset(train=True, transform=train_transform, debug_level=self.debug_level, ltarget_transform=ltarget_transform)
        validset = MNISTSubset(train=True, transform=transform, debug_level=self.debug_level, ltarget_transform=ltarget_transform)
